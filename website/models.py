...
class Message(models.Model):
    ...
    phone = models.CharField(max_length=30, verbose_name="")
    # subject = models.CharField(max_length=128, null=True, blank=True, verbose_name="")
    message = models.TextField(max_length=2800, null=True, blank=True, verbose_name="")
    ...
    def __str__(self):
        ...
        return f'{self.name}..... {self.phone}..... {self.email}..... {self.date}..... {self.message[:80]} .....'
